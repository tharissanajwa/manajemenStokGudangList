...
public class ManajemenGudang {
    ...
    public static void main() {
        ...
        gudang.get(0).add(tambahBarang("Pakaian", "Baju Tidur", "20"));
        gudang.get(0).add(tambahBarang("Pakaian", "Jaket Palka", "30"));

        gudang.add(new ArrayList<>());
        gudang.get(1).add(tambahBarang("Makanan", "Nasi Merah", "10"));
        gudang.get(1).add(tambahBarang("Makanan", "Donat Aceh", "20"));
                    ...
                    while (loopingKategori) {
                        ...
                        switch (pilihanMenuKategori) {
                            case 1 -> {
                                ...
                                tambahKategoriBaru(scanner, gudang); // Memanggil fungsi tambah barang baru dengan menyertakan scanner dan arrayList nya(data set)
                            }
                            case 2 -> {
                    ...
                    while (loopingStok) {
                        ...
                        switch (pilihanMenuStok) {
                            case 1 -> {
                                ...
                                penambahanStokBarang(scanner, gudang, historyStok); // Memanggil fungsi penambahan stok
                            }
                            case 2 -> {
                                System.out.println("Anda memilih menu untuk mengurangi stok barang.");
                                penguranganStokBarang(scanner, gudang, historyStok); // Memanggil fungsi pengurangan stok
                            }
                            case 3 -> {
                                System.out.println("Anda memilih menu untuk melihat barang yang tersedia.");
                                lihatStokBarang(gudang); // Memanggil fungsi lihat stok barang
                            ...
                            case 4 -> {
                                ...
                                lihatHistoryStokBarang(historyStok); // Memanggil fungsi lihat stok barang
                            }
    ...
    private static void tambahKategoriBaru(Scanner scanner, List<List<List<String>>> gudang) {
        ...
        while (!validKategori) {
            ...
            if (categoryExists) {
                ...
                gudang.get(indexCategori).add(tambahBarang(kategoriBaru, null, null));
                System.out.println("==================================================================================================================================");
                ...
                while (!validStok) {
                    ...
                    if (addStokBarang.matches("^[0-9]+$")) {
                        ...
                        if (tambahStokBarang > 0) {
                            ...
                            gudang.get(categoryIndex).add(tambahBarang(kategoriBaru, tambahNamaBarang, addStokBarang));
                            System.out.println("==================================================================================================================================");
    ...
    private static void penguranganStokBarang(Scanner scanner, List<List<List<String>>> gudang, List<String> historyStok) {
                                        ...
                                        for (int indeksBarang = 0; indeksBarang < gudang.get(indeksKategori).size(); indeksBarang++) {
                                            ...
                                            if (barangName != null && barangName.equalsIgnoreCase(tambahNamaBarang)) {
                                                ...
                                                if (updatedStock > 0) {
                                                    ...
                                                    historyStok.add("Pengguna mengurangi " + minusStock + " stok " + barangName + " di tanggal " + formatWaktu() + ".");
    ...
    private static void penambahanStokBarang(Scanner scanner, List<List<List<String>>> gudang, List<String> historyStok) {
    ...
    private static void ubahNamaBarang(Scanner scanner, List<List<List<String>>> gudang) {
    ...
    private static void lihatHistoryStokBarang(List<String> historyStok) {
        System.out.println("Berikut history barang keluar masuk : ");
        for (int indeksHistory = 0; indeksHistory < historyStok.size(); indeksHistory++) {
            System.out.println(indeksHistory+1 + ". " + historyStok.get(indeksHistory));
        }
    }
